...
jQuery.Class("WhatsappBCommon_Js",{
            ...
            AppConnector.request(params).then(
                ...
                app.showModalWindow(data, function(data){
                    jQuery('#sendmessagewb').on("click", function(e) {
                        ...
                        var whatsappUserID = jQuery('#whatsappBusinessUserID').val();
                        if(whatsappUserID == ''){
                            app.helper.showErrorNotification({title: 'Error', message: 'Please select from WhatsApp number'});
                            return false;
                        }
    ...
    registerEventsForSendNewMsgOnSelectRecord : function() {
        ...
        thisInstancewb = this;
        jQuery('.whatsappb #sendwhatsappmsgWB').on('click', function(e){
    ...
    registerEventsForSendNewMsgOnSelectRecordOnEnter : function() {
        var thisInstancewb = this;
        // if(thisInstancewb.getModuleName() == '')
        if ($('.chat-container').hasClass('whatsappb') || app.getModuleName() == 'CTWhatsAppBusiness') {
...
//          });
    ...
    registerEventForWhatsappBusinessscannerTemplate : function(){
        jQuery('#whatsappBusinessUserID').live("change", function(e) {
             var whatsappnumber =$('#whatsappBusinessUserID :selected').text();
             var params = {
                'module' : 'CTWhatsAppBusiness',
                'view' : "MassSendMessages",
                'mode' : "getWhatsappBusinessTemplatesByScannumber",
                'WhatsappNumber' : whatsappnumber
            }
            AppConnector.request(params).then(
                function(data) {
    ...
    registerEvents : function(form) {
        ...
        this.registerEventForWhatsappBusinessscannerTemplate();
